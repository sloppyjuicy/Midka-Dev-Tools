...
function createConfig(options) {
    ...
    fs_1.default.writeFileSync(options.targetDirectory + 'config.json', data);
}
function dirCheck(options) {
...
async function createProject(options) {
    ...
    options = {
        ...options,
        targetDirectory: path_1.default.join(__dirname, options.suppliedDirectory, '/'),
    };
